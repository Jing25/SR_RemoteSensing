...
def bgr2ycbcr(img, only_y=True):
    ...
    # convert
    if only_y:
        rlt = np.dot(img_c, [24.966, 128.553, 65.481]) / 255.0 + 16.0
    else:
        rlt = np.matmul(img_c, [[24.966, 112.0, -18.214], [128.553, -74.203, -93.786],
...
def ycbcr2rgb(img):
    ...
    if in_img_type != np.uint8:
        img_c = img * 255.
    # convert
    rlt = np.matmul(img_c, [[0.00456621, 0.00456621, 0.00456621], [0, -0.00153632, 0.00791071],
...
if __name__ == '__main__':
    ...
    # read images
    #img = io.imread('x4_32_255.tif')
    img = cv2.imread('x4_32_255.tif')
    img = img * 1.0 / 255
